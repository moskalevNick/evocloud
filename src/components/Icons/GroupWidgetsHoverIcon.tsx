...
type GroupWidgetsHoverIconType = {
  width?: string;
  height?: string;
};

export const GroupWidgetsHoverIcon: React.FC<GroupWidgetsHoverIconType> = ({
  height = '20',
  width = '20',
}) => (
  <svg
  ...
  >
    <g filter="url(#filter0_d_147_12358)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
    ...
    <defs>
      ...
      >
        ...
        />
        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_147_12358" />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_147_12358"
          result="shape"
        />
      </filter>
    </defs>
