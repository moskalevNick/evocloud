...
export const LayoutActiveIcon: React.FC<IconType> = ({ height = '20', width = '20' }) => (
  <svg
    width={width}
    height={height}
  ...
  >
    <g filter="url(#filter0_d_124_3593)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
    ...
    <defs>
      ...
      >
        ...
        />
        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_124_3593" />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_124_3593"
          result="shape"
        />
      </filter>
    </defs>
