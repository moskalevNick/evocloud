...
export const EditHoverIcon: React.FC<EditIconType> = ({
  height = '21',
  width = '22',
  fill = '#1D5D93',
}) => (
  ...
  >
    <g filter="url(#filter0_d_147_12367)">
      <path
    ...
    <g opacity="0.5" filter="url(#filter1_d_147_12367)">
      <path
    ...
    <defs>
      ...
      >
        ...
        />
        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_147_12367" />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_147_12367"
          result="shape"
        />
      </filter>
      <filter
        id="filter1_d_147_12367"
        x="0.500488"
        y="0.87793"
        width="21"
        height="21"
